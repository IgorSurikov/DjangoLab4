...
urlpatterns = [
    ...
    path('<int:product_id>/', app.views.product_grades,
         name='product_grades'),
    path('<int:instance_id>/edit/', app.views.edit_product,
         name='edit_product'),
    path('<int:instance_id>/delete/', app.views.delete_product,
         name='delete_product'),
    ...
    url('confirmation/(?P<user_id>\d+)/', app.views.email_confirmation,
